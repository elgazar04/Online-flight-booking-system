<?php
    ...
    if(isset($_POST['Cancel_train']))
    {
            ...
            */
            ...
            if($stmt)
            {
                $succ = "Reserved Flight Cancelled";
            }
            else 
            {
  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Canel My flight </h2>
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              <li class="breadcrumb-item"><a href="pass-dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="#">Book Flight</a></li>
              <li class="breadcrumb-item active">Cancel Flight</li>
            </ol>
          </nav>
        </div>
            <?php if(isset($succ)) {?>
