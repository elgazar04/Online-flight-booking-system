			...
			<div id="page-wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
						<h1><a href="index.php">Online Flight Booking</a></h1>
						<nav>
							<a href="#menu">Menu</a>
						</nav>
					</header>
				...
				<!-- Banner -->
					<section id="banner">
						<div class="inner">
							...
							<p>Best, Simple, and User Friendly Way To Reserve Airplane Tickets Effectively</a></p>
						</div>
					</section>
					...
					<section id="footer">
						<div class="inner">
							...
							<ul class="contact">
								...
								Online Flight Booking<br />
									PHP Project<br />
									
								</li>
								<li class="icon solid fa-phone">(+020)1201141099</li>
							...
							<ul class="copyright">
								<li>&copy; Online Flight Booking</li><li>Developed By: Gazar & Mohamed Essam</li>
							</ul>
						</div>
					</section>
