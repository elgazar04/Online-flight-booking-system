              ...
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-face"></i><span><?php echo $row->pass_uname;?>'s Profile</span></a>
                    ...
                    <?php }?>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-train"></i><span>Flights</span></a>
                  
                    <ul class="sub-menu">
                       <li><a href="pass-all-available-trains.php">All Available Flights</a>
                       <li><a href="pass-search-available-trains.php">Search Flights</a>
                    </li>
                      
                    </ul>
                
                  </li>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-briefcase-edit-outline"></i><span>Book Flight</span></a>
                    <ul class="sub-menu">
                      <li><a href="pass-book-train.php">Reserve Flight</a>
                      </li>
                      <li><a href="pass-cancel-train.php">Cancel Flight</a>
                      </li>
