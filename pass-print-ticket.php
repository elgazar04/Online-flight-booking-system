  ...
  <body>
    ...
    <!--Nav Bar-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Flight Ticket</h2>
            ...
            <!--train Details-->
              <div id='printReceipt' class="invoice">
                <div class="row invoice-header">
                  ...
                  <div class="col-sm-5 invoice-order"><span class="invoice-id">Flight Ticket For</span><span class="incoice-date"><?php echo $row->pass_fname;?> <?php echo $row->pass_lname;?></span></div>
                </div>
